...
#ifndef POILABSPOSITIONING_SWIFT_H
#define POILABSPOSITIONING_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PoilabsPositioning",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18PoilabsPositioning15PLPBeaconFilter")
@interface PLPBeaconFilter : NSObject
- (nullable instancetype)initWithUuid:(NSString * _Nonnull)uuid majors:(NSArray<NSNumber *> * _Nonnull)majors isEncrypted:(BOOL)isEncrypted OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC18PoilabsPositioning13PLPBeaconNode")
@interface PLPBeaconNode : NSObject
...
- (NSString * _Nullable)getZoneIdFor:(CLLocationCoordinate2D)coordinate SWIFT_WARN_UNUSED_RESULT;
...
typedef SWIFT_ENUM(NSInteger, PLPLocationStatusReason, open) {
  ...
  PLPLocationStatusReasonTimeOut = 1,
  PLPLocationStatusReasonSensorError = 2,
  PLPLocationStatusReasonEmptyList = 3,
  PLPLocationStatusReasonInvalidUUID = 4,
  PLPLocationStatusReasonBeaconNotFound = 5,
  PLPLocationStatusReasonNoReason = 6,
};

typedef SWIFT_ENUM(NSInteger, PLPStatus, open) {
  PLPStatusLocationFound = 0,
  PLPStatusWaitingForLocation = 1,
  PLPStatusLocationNotFound = 2,
  PLPStatusLocationingStoped = 3,
};
...
SWIFT_CLASS("_TtC18PoilabsPositioning21PLPositioningModeInfo")
@interface PLPositioningModeInfo : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_PROTOCOL("_TtP18PoilabsPositioning26PoilabsPositioningDelegate_")
@protocol PoilabsPositioningDelegate
...
- (void)poilabsPositioningWithDidUpdateLocation:(CLLocationCoordinate2D)location floorLevel:(NSInteger)floorLevel accuracy:(double)accuracy placeId:(NSString * _Nonnull)placeId;
...
- (void)poilabsPositioningWithDidUpdateLocation:(CLLocation * _Nonnull)location placeId:(NSString * _Nonnull)placeId;
- (void)poilabsPositioningWithDidUpdate:(PLPositioningModeInfo * _Nonnull)modeInfo;
@end

typedef SWIFT_ENUM(NSInteger, PoilabsPositioningError, open) {
  PoilabsPositioningErrorEmptyList = 0,
  PoilabsPositioningErrorInvalidUUID = 1,
  PoilabsPositioningErrorDidFailWithError = 2,
  PoilabsPositioningErrorMonitoringDidFailFor = 3,
  PoilabsPositioningErrorDidFailRangingFor = 4,
  PoilabsPositioningErrorTimeIntervalInvalid = 5,
  PoilabsPositioningErrorBeaconNotFound = 6,
  PoilabsPositioningErrorBluetoothNotAvaible = 7,
  PoilabsPositioningErrorLocationNotAvaible = 8,
};
